...
def get_last_orientation():
    ...
    test_dict = {'heading':np.asarray(oreintaion['attitude']['heading_update_source_state']['heading']),
                 'pitch':np.asarray(oreintaion['attitude']['orientation_euler_angles']['pitch']),
                 'roll':np.asarray(oreintaion['attitude']['orientation_euler_angles']['roll']),
                 'yaw':np.asarray(oreintaion['attitude']['orientation_euler_angles']['yaw']),
                 'valid_heading':np.asarray(oreintation['attitude']['orientation_euler_angles']['valid']),
                 'valid_oreintation':np.asarray(oreintation['attitude']['orientation_euler_angles']['valid'])
    }
    return test_dict
